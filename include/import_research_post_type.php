<?php function import_admin_menu_research() {
    add_menu_page(
        __( 'Research Spot', 'my-textdomain' ),
        __( 'Research Spot', 'my-textdomain' ),
        'manage_options',
        'research-import',
        'research_admin_page_import',
        'dashicons-schedule',
        100
    );
}
add_action( 'admin_menu', 'import_admin_menu_research' );
use PhpOffice\PhpSpreadsheet\Spreadsheet;
use PhpOffice\PhpSpreadsheet\Writer\Xlsx;



function research_admin_page_import() { ?>
